...
void OSLToyRenderer::render_image()
{
...
void OSLToyRenderer::camera_params(const Matrix44 &world_to_camera,
...
bool OSLToyRenderer::get_matrix(ShaderGlobals * /*sg*/, Matrix44 &result,
...
bool OSLToyRenderer::get_inverse_matrix(ShaderGlobals * /*sg*/, Matrix44 &result,
...
void OSLToyRenderer::name_transform(const char *name, const OSL::Matrix44 &xform)
{
  std::shared_ptr<Transformation> M(new OSL::Matrix44(xform));
  m_named_xforms[ustring(name)] = M;
}

bool OSLToyRenderer::get_array_attribute(ShaderGlobals *sg, bool derivatives,
                                         ...
                                         int index, void *val)
{
  ...
  // "options"/"blahblah"
  if (object == "options" && name == "blahblah" && type == TypeDesc::TypeFloat)
  {
    *(float *)val = 3.14159;
    return true;
  }
...
bool OSLToyRenderer::get_attribute(ShaderGlobals *sg, bool derivatives,
                                   ustring object, TypeDesc type, ustring name,
                                   void *val)
{
...
bool OSLToyRenderer::get_userdata(bool derivatives, ustring name, TypeDesc type,
...
bool OSLToyRenderer::get_osl_version(ShaderGlobals * /*sg*/, bool /*derivs*/,
...
bool OSLToyRenderer::get_camera_resolution(ShaderGlobals * /*sg*/, bool /*derivs*/,
                                           ustring /*object*/, TypeDesc type,
                                           ustring /*name*/, void *val)
{
...
bool OSLToyRenderer::get_camera_projection(ShaderGlobals * /*sg*/, bool /*derivs*/,
                                           ustring /*object*/, TypeDesc type,
                                           ustring /*name*/, void *val)
{
...
bool OSLToyRenderer::get_camera_fov(ShaderGlobals * /*sg*/, bool derivs,
                                    ustring /*object*/, TypeDesc type,
                                    ustring /*name*/, void *val)
{
...
bool OSLToyRenderer::get_camera_pixelaspect(ShaderGlobals * /*sg*/, bool derivs,
                                            ustring /*object*/, TypeDesc type,
                                            ustring /*name*/, void *val)
{
  if (type == TypeDesc::TypeFloat)
...
bool OSLToyRenderer::get_camera_clip(ShaderGlobals * /*sg*/, bool derivs,
                                     ustring /*object*/, TypeDesc type,
                                     ustring /*name*/, void *val)
{
...
bool OSLToyRenderer::get_camera_clip_near(ShaderGlobals * /*sg*/, bool derivs,
                                          ustring /*object*/, TypeDesc type,
                                          ustring /*name*/, void *val)
{
  if (type == TypeDesc::TypeFloat)
...
bool OSLToyRenderer::get_camera_clip_far(ShaderGlobals * /*sg*/, bool derivs,
                                         ustring /*object*/, TypeDesc type,
                                         ustring /*name*/, void *val)
{
  if (type == TypeDesc::TypeFloat)
...
bool OSLToyRenderer::get_camera_shutter(ShaderGlobals * /*sg*/, bool derivs,
                                        ustring /*object*/, TypeDesc type,
                                        ustring /*name*/, void *val)
{
  if (type == TypeFloatArray2)
...
bool OSLToyRenderer::get_camera_shutter_open(ShaderGlobals * /*sg*/, bool derivs,
                                             ustring /*object*/, TypeDesc type,
                                             ustring /*name*/, void *val)
{
  if (type == TypeDesc::TypeFloat)
...
bool OSLToyRenderer::get_camera_shutter_close(ShaderGlobals * /*sg*/, bool derivs,
                                              ustring /*object*/, TypeDesc type,
                                              ustring /*name*/, void *val)
{
  if (type == TypeDesc::TypeFloat)
...
bool OSLToyRenderer::get_camera_screen_window(ShaderGlobals * /*sg*/, bool derivs,
                                              ustring /*object*/, TypeDesc type,
                                              ustring /*name*/, void *val)
{
  // N.B. in a real renderer, this may be time-dependent
