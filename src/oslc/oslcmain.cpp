...
int main(int argc, const char *argv[])
{
  ...
  for (int a = 1; a < argc; ++a)
  {
    ...
    else if (!strcmp(argv[a], "-E") || !strcmp(argv[a], "-M") || !strcmp(argv[a], "--dependencies") || !strcmp(argv[a], "-MM") || !strcmp(argv[a], "--user-dependencies"))
    {
      args.emplace_back(argv[a]);
      quiet = true;
    }
    else if (!strcmp(argv[a], "-v") || !strcmp(argv[a], "-d") || !strcmp(argv[a], "-O") || !strcmp(argv[a], "-O0") || !strcmp(argv[a], "-O1") || !strcmp(argv[a], "-O2") || !strcmp(argv[a], "-Werror") || !strcmp(argv[a], "-embed-source") || !strcmp(argv[a], "--embed-source") || !strcmp(argv[a], "-MD") || !strcmp(argv[a], "--write-dependencies") || !strcmp(argv[a], "-MMD") || !strcmp(argv[a], "--write-user-dependencies") || OIIO::Strutil::starts_with(argv[a], "-MF") || OIIO::Strutil::starts_with(argv[a], "-MT"))
    {
      // Valid command-line argument
      args.emplace_back(argv[a]);
      if (a < argc - 1 && (!strcmp(argv[a], "-MF") || !strcmp(argv[a], "-MT")))
      {
        ++a;
        args.emplace_back(argv[a]);
      }
    ...
    else if (argv[a][0] == '-' && (argv[a][1] == 'D' || argv[a][1] == 'U' || argv[a][1] == 'I'))
    {
      args.emplace_back(argv[a]);
    }
