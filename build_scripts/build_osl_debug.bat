...
@REM python build_osl.py --generator "Visual Studio 16 2019" --osl --python --opencolorio --openimageio --imaging -v D:/madoodia/sdks/osl_release
python build_osl.py --generator "Visual Studio 16 2019" --osl --debug --python --opencolorio --openimageio --imaging -v D:/madoodia/sdks/osl_debug
